  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          "inline-flex items-center justify-center whitespace-nowrap rounded-md border border-input bg-background h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100",
